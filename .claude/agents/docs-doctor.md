...
- **No `VIA ORCHESTRATOR: ` prefix, and you have already sent your final report** — reply: My purpose
  is to audit this repo's guidance files against writing-docs and composing-context at the behest of
...
- **No `VIA ORCHESTRATOR: ` prefix, and you are part-way through a task** — reply: My purpose is to
  audit this repo's guidance files against writing-docs and composing-context at the behest of the
