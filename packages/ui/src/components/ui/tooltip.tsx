...
function TooltipContent({
  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        {children}
        {/* The arrow is part of the surface, so it takes the same fill and the
          same border as the body — two of its sides are the ones the body's
          border would have covered. Without this it renders as a detached
          shape in the opposite theme's colour, and no prop reaches it from
